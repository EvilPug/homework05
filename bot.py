...
>>>>>>> 8df6447aea2c4be0e474c3a61b4bbac59f5abc5e
    if week:
        week = str(week) + '/'
...
<<<<<<< HEAD
response = requests.get('http://www.ifmo.ru/ru/schedule/0/K3143/2/raspisanie_zanyatiy_GROUP.htm')
=======
>>>>>>> 8df6447aea2c4be0e474c3a61b4bbac59f5abc5e
